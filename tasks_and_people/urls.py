...
urlpatterns = [
    ...
    path('people/<int:id>/tasks', views.person_task_details),
    path('tasks/<int:id>/owner', views.set_or_get_task_owner),
    path('tasks/<int:id>/status', views.set_or_get_task_status),
